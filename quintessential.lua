...
if should_have_lovely then
    ...
    assert(SMODS.current_mod.lovely, "Failed to detect Quintessential lovely patches.\nMake sure your quintessential folder is not nested (there should be a bunch of files in the quintessential folder and not just another folder).\n\n\n")
end

-- load all individual jokers
local subdir = "src/jokers"
